 ...
 import imag from "./imag.webp"
  ...
  //  const [Person, setPerson] = useState([{fullName='hana melki'} ,{bio='I love anime and im so passionate about it '} , {imgSrc={hana}} ,{profession='senior web developer'} ,{bool=false}]);
